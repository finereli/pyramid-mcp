...
Before any frequency or streak claim ("three nights in a row", "every time you..."), enumerate the specific dated notes it rests on; if you can't enumerate them, say "at least" or don't claim it. Count what was recorded, not what you sense — and a gap in the notes is a gap, not evidence either way.
